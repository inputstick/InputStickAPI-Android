...
public class CzechLayoutQwerty extends KeyboardLayout {
	...
	public static final String LAYOUT_VARIANT = 		"CZ QWERTY";
	...
	private static final int[][] FAST_LUT = {
		...
		{   90,	    2,	   29,	    0,	    0	},	// Z
		{   91,	   64,	   47,	    0,	    0	},	// [
		{   92,	   64,	   49,	    0,	    0	},	// backslash
		{   93,	   64,	   48,	    0,	    0	},	// ]
		{   94,	   64,	   35,	    0,	    0	},	// ^ fixed! "deadkey" is duplicated in this layout!  altGr+6 = ^ (not deadkey); shift+altGr+' = deadkey
		{   95,	   66,	   45,	    0,	    0	},	// _
		{   96,	   64,	   53,	    0,	    0	},	// `
		{   97,	    0,	    4,	    0,	    0	},	// a
		{   98,	    0,	    5,	    0,	    0	},	// b
		...
		{  180,	    0,	   44,	    0,	   46	},	// ´
		{  193,	    2,	    4,	    0,	   46	},	// Á
		{  194,	    2,	    4,	   66,	   52	},	// Â 	"^ deadkey" issue
		{  196,	    2,	    4,	    0,	   49	},	// Ä
		{  197,	    2,	    4,	    2,	   53	},	// Å
		{  201,	    2,	    8,	    0,	   46	},	// É
		{  202,	    2,	    8,	   66,	   52	},	// Ê 	"^ deadkey" issue
		{  203,	    2,	    8,	    0,	   49	},	// Ë
		{  205,	    2,	   12,	    0,	   46	},	// Í
		{  206,	    2,	   12,	   66,	   52	},	// Î 	"^ deadkey" issue
		{  207,	    2,	   12,	    0,	   49	},	// Ï
		{  211,	    2,	   18,	    0,	   46	},	// Ó
		{  212,	    2,	   18,	   66,	   52	},	// Ô 	"^ deadkey" issue
		{  214,	    2,	   18,	    0,	   49	},	// Ö
		{  215,	   66,	   54,	    0,	    0	},	// ×
		{  218,	    2,	   24,	    0,	   46	},	// Ú
		{  219,	    2,	   24,	   66,	   52	},	// Û  	"^ deadkey" issue
		{  220,	    2,	   24,	    0,	   49	},	// Ü
		{  221,	    2,	   28,	    0,	   46	},	// Ý
		{  223,	   64,	  100,	    0,	    0	},	// ß
		{  225,	    0,	   37,	    0,	    0	},	// á
		{  226,	    0,	    4,	   66,	   52	},	// â 	"^ deadkey" issue
		{  228,	    0,	    4,	    0,	   49	},	// ä
		{  229,	    0,	    4,	    2,	   53	},	// å
		{  233,	    0,	   39,	    0,	    0	},	// é
		{  234,	    0,	    8,	   66,	   52	},	// ê 	"^ deadkey" issue
		{  235,	    0,	    8,	    0,	   49	},	// ë
		{  237,	    0,	   38,	    0,	    0	},	// í
		{  238,	    0,	   12,	   66,	   52	},	// î 	"^ deadkey" issue
		{  239,	    0,	   12,	    0,	   49	},	// ï
		{  243,	    0,	   18,	    0,	   46	},	// ó
		{  244,	    0,	   18,	   66,	   52	},	// ô 	"^ deadkey" issue
		{  246,	    0,	   18,	    0,	   49	},	// ö
		{  247,	   66,	   55,	    0,	    0	},	// ÷
		{  250,	    0,	   47,	    0,	    0	},	// ú
		{  251,	    0,	   24,	   66,	   52	},	// û 	"^ deadkey" issue
		{  252,	    0,	   24,	    0,	   49	},	// ü
		{  253,	    0,	   36,	    0,	    0	},	// ý
		{  255,	    0,	   28,	    0,	   49	},	// ÿ
		{  262,	    2,	    6,	    0,	   46	},	// Ć
	...
	public static final int LUT[][] = {		
		...
		/*	0a	*/	{	0	,	0x00ed		,	(int)'9'	,	-1		,	0x0028	,	-1		}	,
		/*	0b	*/	{	0	,	0x00e9		,	(int)'0'	,	-1		,	0x0029	,	-1		}	,
		/*	0c	*/	{	0	,	0x003d		,	0x0025		,	-1		,	0x002d	,	0x005f	}	,
		/*	0d	*/	{	0	,	0x00b4		,	0x02c7		,	-1		,	0x003d	,	0x002b	}	,
		/*	0e	*/	{	-1	,	0			,	0			,	0		,	0		,	0		}	,
		/*	0f	*/	{	-1	,	0			,	0			,	0		,	0		,	0		}	,			
		...
		/*	1a	*/	{	0	,	0x00fa		,	0x002f		,	-1		,	0x005b	,	0x007b	}	,
		/*	1b	*/	{	0	,	0x0029		,	0x0028		,	0x001b	,	0x005d	,	0x007d	}	,
		/*	1c	*/	{	-1	,	0			,	0			,	0		,	0		,	0		}	,
		/*	1d	*/	{	-1	,	0			,	0			,	0		,	0		,	0		}	,
		...
		/*	27	*/	{	0	,	0x016f		,	0x0022		,	0x001d	,	0x003b	,	0x003a	}	,
		/*	28	*/	{	0	,	0x00a7		,	0x0021		,	-1		,	0x00a4	,	0x005e	}	,
		/*	29	*/	{	0	,	0x003b		,	0x00b0		,	-1		,	0x0060	,	0x007e	}	,
		/*	2a	*/	{	-1	,	0			,	0			,	0		,	0		,	0		}	,
		/*	2b	*/	{	0	,	0x00a8		,	0x0027		,	0x001c	,	0x005c	,	0x007c	}	,
		...
		/*	33	*/	{	0	,	0x002c		,	0x003f		,	-1		,	0x003c	,	0x00d7	}	,
		/*	34	*/	{	0	,	0x002e		,	0x003a		,	-1		,	0x003e	,	0x00f7	}	,
		/*	35	*/	{	0	,	0x002d		,	0x005f		,	-1		,	0x002f	,	0x003f	}	,
		/*	36	*/	{	-1	,	0			,	0			,	0		,	0		,	0		}	,
		/*	37	*/	{	-1	,	0			,	0			,	0		,	0		,	0		}	,
		/*	38	*/	{	-1	,	0			,	0			,	0		,	0		,	0		}	,			
	...
	public static final int DEADKEYS[] = {
		0x00a8, 0x00b0, 0x00b4, 0x005e, 0x02c7, 0x02dd
	};
	...
	private static CzechLayoutQwerty instance = new CzechLayoutQwerty();
	
	private CzechLayoutQwerty() {
	}
	
	public static CzechLayoutQwerty getInstance() {
		return instance;
	}	
