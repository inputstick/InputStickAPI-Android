...
public class CzechLayoutAlt extends KeyboardLayout {
	
	public static final String LOCALE_NAME = 			"cs-CZ-1";
	public static final String LAYOUT_NAME_NATIVE =	 	"Čeština";
	public static final String LAYOUT_NAME_ENGLISH = 	"Czech";
	public static final String LAYOUT_VARIANT = 		"CZ (Czech)";
	...
	private static CzechLayoutAlt instance = new CzechLayoutAlt();
	
	private CzechLayoutAlt() {
	}
	
	public static CzechLayoutAlt getInstance() {
		return instance;
	}	
