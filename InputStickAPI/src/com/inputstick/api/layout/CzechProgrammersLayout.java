...
public class CzechProgrammersLayout extends KeyboardLayout {
	
	public static final String LOCALE_NAME = 			"cs-CZ-pro";
	...
	private static CzechProgrammersLayout instance = new CzechProgrammersLayout();
	
	private CzechProgrammersLayout() {
	}
	
	public static CzechProgrammersLayout getInstance() {
		return instance;
	}	
