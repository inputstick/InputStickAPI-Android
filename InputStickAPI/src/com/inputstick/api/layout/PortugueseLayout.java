...
public class PortugueseLayout  extends KeyboardLayout {
	
	public static final String LOCALE_NAME = 			"pt-PT";
	public static final String LAYOUT_NAME_NATIVE = 	"Português";
	public static final String LAYOUT_NAME_ENGLISH = 	"Portuguese";
	public static final String LAYOUT_VARIANT = 		"PT";
	...
	/*	03	*/	{	0	,	(int)'2'	,	0x0022	,	-1	,	0x0040	,	-1	}	,
	/*	04	*/	{	0	,	(int)'3'	,	0x0023	,	-1	,	0x00a3	,	-1	}	,
	/*	05	*/	{	0	,	(int)'4'	,	0x0024	,	-1	,	0x00a7	,	-1	}	,
	/*	06	*/	{	0	,	(int)'5'	,	0x0025	,	-1	,	0x20ac	,	-1	}	,
	/*	07	*/	{	0	,	(int)'6'	,	0x0026	,	-1	,	-1		,	-1	}	,
	/*	08	*/	{	0	,	(int)'7'	,	0x002f	,	-1	,	0x007b	,	-1	}	,
	/*	09	*/	{	0	,	(int)'8'	,	0x0028	,	-1	,	0x005b	,	-1	}	,
	/*	0a	*/	{	0	,	(int)'9'	,	0x0029	,	-1	,	0x005d	,	-1	}	,
	/*	0b	*/	{	0	,	(int)'0'	,	0x003d	,	-1	,	0x007d	,	-1	}	,
	/*	0c	*/	{	0	,	0x0027		,	0x003f	,	-1	,	-1		,	-1	}	,
	/*	0d	*/	{	0	,	0x00ab		,	0x00bb	,	-1	,	-1		,	-1	}	,
	/*	0e	*/	{	-1	,	0			,	0		,	0	,	0		,	0	}	,
	/*	0f	*/	{	-1	,	0			,	0		,	0	,	0		,	0	}	,			
	...
	/*	1a	*/	{	0	,	0x002b		,	0x002a		,	-1		,	0x00a8	,	-1	}	,
	/*	1b	*/	{	0	,	0x00b4		,	0x0060		,	-1		,	0x005d	,	-1	}	,
	/*	1c	*/	{	-1	,	0			,	0			,	0		,	0		,	0	}	,
	/*	1d	*/	{	-1	,	0			,	0			,	0		,	0		,	0	}	,	
	...
	/*	27	*/	{	1	,	0x00e7		,	0x00c7		,	-1		,	-1		,	-1	}	,
	/*	28	*/	{	0	,	0x00ba		,	0x00aa		,	-1		,	-1		,	-1	}	,
	/*	29	*/	{	0	,	0x005c		,	0x007c		,	-1		,	-1		,	-1	}	,
	/*	2a	*/	{	-1	,	0			,	0			,	0		,	0		,	0	}	,	
	/*	2b	*/	{	0	,	0x007e		,	0x005e		,	-1		,	-1		,	-1	}	,
	...
	private static PortugueseLayout instance = new PortugueseLayout();
	
	private PortugueseLayout() {
	}
	
	public static PortugueseLayout getInstance() {
		return instance;
	}	
